...
$dosimetrist = array(44,45, 46, 105,121,47,52, 53, 62,56,76,106,164, 251,213,214, 58,158,60,61,104,261,234,  280,283, 287, 323, 324, 342, 344, 345, 
 357, 358, 382, 429, // added 342 Botticello 8-20-24
   ...
   $selStr = "SELECT LastName, FirstName, UserKey FROM physicists WHERE UserKey IN (448, 467, 470, 503, 507, 509, 494, 634, 641, 683, 715,716, 728, 729, 753,799,  838, 801,838, 888,893, 894,
	 948, 999, 919, 952, 997,999,1001,1007, 1027,1045, 1055) ORDER BY LastName";
   fwrite($fp, "\r\n $selStr");
